...
> **현재 상태 (v0.3.0)**: 앱은 가짜 카트(시뮬레이션)와 WebSocket 연결(테스트 서버·실차)을 모두 지원합니다.
> 카트 쪽 펌웨어와 서버는 아직 없고, 통신 규약 보강이 남아 있습니다.
> 준비된 것·확인한 것·알려진 위험·다음 단계는 **[진행 상황](docs/STATUS.md)** 에 정리돼 있습니다.
